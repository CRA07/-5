...
WAREHOUSE_DEFECTS = ["пришел другой дозатор", "сломанный дозатор", "нет этикетки", "нет дозатора", "нет товара", "пришел разбитым", "перепутан штрихкод", "перепутан товар", "проблема с этикеткой", "просрочка", "в комплекте 1 товар", "вскрытая банка", "проблема с упаковкой"]
...
DEFECT_CATEGORIES = {
    ...
    "проблема с упаковкой": "упаковка",
    "сломанный дозатор": "перевозка",
    "в комплекте 1 товар": "комплектация",
    "вскрытая банка": "упаковка",
    "просрочка": "просрочка"}

PRODUCTION_DEFECTS = ["нет даты производства ", "пустая банка", "банка без защитной фольги", "недостающее количество капсул", "капсулы в масле", "капсулы в пятнах",
                      "черная крышка внутри банки", "мусор в банке", "нет мерной ложки", "неприятный запах от капсул", "пустые капсулы в банке ",
                      "просрочка", "вскрытая банка", "нет этикетки", "проблема с этикеткой", "проблема с дозатором", "проблема с консистенцией", "вскрыт пакет с силикагелем", "капсулы мутные",
                      "плесень ", ]
