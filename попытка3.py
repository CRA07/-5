...
WAREHOUSE_DEFECTS = ["пришел другой дозатор", "сломанный дозатор", "нет этикетки", "нет дозатора",
                     "нет товара", "пришел разбитым", "перепутан штрихкод", "перепутан товар", "проблема с этикеткой", "просрочка", "в комплекте 1 товар"; "вскрытая банка", "проблема с упаковкой"]
